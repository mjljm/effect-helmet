...
export type CspGeneralSources = DV.DirectiveValue<KW.UrlKeywords>;

/**
 * Creates a CspGeneralSources with 'none' as unique allowed source
...
/**
 * Creates a CspGeneralSources with 'self' as unique allowed source
 * Remark: empty not allowed for this directive
 * @since 1.0.0
 * @category constructors
 */
...
export const setReportSample = DV.setReportSample;
...
export const unsetReportSample = DV.unsetReportSample;
